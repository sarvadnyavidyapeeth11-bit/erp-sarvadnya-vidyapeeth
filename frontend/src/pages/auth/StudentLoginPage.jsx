...
export default function StudentLogin() {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    setError("");
    const loginId = rollNumber.trim();
    const matched = getStudentVerifications().find((student) => (
      student.scholarNo === loginId ||
      student.rollNumber === loginId ||
      student.enrollmentNo === loginId ||
      student.loginUsername === loginId
    ));
    const expectedPassword = matched?.loginPassword || matched?.scholarNo;
    if (!matched || !password || password !== expectedPassword) {
      setLoading(false);
      setSuccessMsg("");
      setError("Invalid student ID or password. Use the credentials generated by Admission Desk.");
      return;
    }
